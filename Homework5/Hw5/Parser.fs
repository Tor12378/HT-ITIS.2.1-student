...
let parseArgumentToDouble (arg: string) =
...
let parseArgs (args: string[]): Result<('a * CalculatorOperation * 'b), Message> =
    maybe {
        let! args = (args[0],args[1], args[2]) |> isOperationSupported
        let! arg1 = args.Item1 |> parseArgumentToDouble
        let! arg2 = args.Item3 |> parseArgumentToDouble
        return (arg1, args.Item2, arg2)
    }
